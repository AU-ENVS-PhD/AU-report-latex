...
\lhead{\Title}
\rfoot{\includegraphics[height=1.25cm]{root/ausegl_blaa.pdf}} % right header logo
\lfoot{\includegraphics[height=1.25cm]{root/DP logo FINAL.png}} % left header logo
